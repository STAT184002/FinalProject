...
```
 This is just another way to look at this data. It's very ugly and should not be used, but allows a simple alternative view that allows for schrolling and an easier way to look at each country indivudally. 
