...
---
## Link to GitHub Repo
link: https://github.com/STAT184002/FinalProject.git
...
```
 This is another way to look at this data. It is not very uawful and we did not find it as beneficial as the other inspection methods. should not be used, but allows a simple alternative view that allows for schrolling and an easier way to look at each country indivudally. 
